...
/** Troca para o estado lex especificado. */
public void SwitchTo(int lexState)
{
   if (lexState >= 1 || lexState < 0)
      throw new TokenMgrError("Erro: Ignorando estado léxico inválido : " + lexState + ". Estado inalterado.", TokenMgrError.INVALID_LEXICAL_STATE);
   else
