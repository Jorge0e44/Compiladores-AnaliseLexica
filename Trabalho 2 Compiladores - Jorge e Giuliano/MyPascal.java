...
class MyPascal/*@bgen(jjtree)*/implements MyPascalTreeConstants, MyPascalConstants {/*@bgen(jjtree)*/
  protected JJTMyPascalState jjtree = new JJTMyPascalState();public static void main(String[] args) throws ParseException {
                ...
                try{
                        ...
                        System.out.println("Analise com sucesso !! Analise Lexica e sintatica sem erros");
 ...
 * Funções para Analise sintatica
  ...
  Foi utilizado a declaração final pois Quando é aplicado na classe, não permite estende-la, 
  nos métodos impede que o mesmo seja sobrescrito (overriding) na subclasse, 
  e nos valores de variáveis não pode ser alterado depois que já tenha sido atribuído um valor.
 */
...
// Programa completo composto de cabeçalho do programa, declarações de variaveis e funções, e função principal
  ...
  jjtree.openNodeScope(jjtn000);
    ...
    throw new Error("Declaracao de retorno ausente na funcao");
  }
...
//Chamada de funcao tipo variavel 
